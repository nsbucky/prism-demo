...
const sampleCode = `$promptView = view('lyrics', [
...
<template>
    <BaseSlide>
        <template #title>Final Prompt - use Blade!</template>
        <template #content>

            <p>Prism allows you to use Laravel Blade to format your final prompt.</p>
